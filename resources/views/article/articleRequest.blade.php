...
@section('content')
    ...
    <x-modal id="approvedModal" title="Approved Conformation" message="Are you sure you want to approved this news?" btn="Yes, Approved It!" btnId="approvedBtn" />
    {{-- Appreved Modal End --}}

    {{-- Delete Modal Start --}}
    <x-modal id="removeModal" title="Delete Conformation" message="Are you sure you want to remove this news?" btn="Yes, Delete It!" btnId="delete" />
    {{-- Delete Modal End --}}
